...
def evaluate(params):
  ...
  log_path = osp.join('eval_log', params['dataset'], params['id'] + '.log')
  log_category_path = osp.join('eval_log', params['dataset'], params['id']+'_category.log')
  log = open(log_path, 'a', buffering=1)
  log_category = open(log_category_path, 'a', buffering=1)

  # load mode info
  # if params["task"] == 5:
  #   model_prefix = osp.join('output', params['dataset_splitBy'], params['id'], 'outdoor', params['id'])
  # else:
  # model_prefix = osp.join('output', params['dataset_splitBy'], params['id'], params['id'])
  infos = json.load(open('/home/chencheng/Code/MAttNet/output/refcocog_umd/mrcn_cmr_with_st.json'))
  model_opt = infos['opt']
  model_path = '/home/chencheng/Code/MAttNet/output/refcocog_umd/mrcn_cmr_with_st.pth'
